...
<sup>‡</sup> Corresponding author. e-mail: alain.junod@physics.unige.ch
...
| a (Å)                   | 5.293±0.001   |  |
| Tm<br>(K)               | 40~45         |  |
| a<br>/<br>c             | 1.0026±0.0001 |  |
| Vgat (cm3<br>gat-1<br>) | 11.085±0.005  |  |
| γ (mJ K-2<br>gat-1<br>) | 13.7±0.2      |  |
| ΘD<br>(0)<br>(K)        | 233.7±2       |  |
| Hc2<br>(0)<br>(T)       | 25±0.5        |  |
| Hc<br>(0)<br>(T)        | 0.52±0.01     |  |
| Hc1<br>(0)<br>(T)       | 0.038         |  |
| ξ (Å)                   | 36            |  |
| λ (Å)                   | 1240          |  |
| κ                       | 34            |  |

Table II. Comparison of the parameters of the two-gap model in Nb3Sn (this work) and MgB<sup>2</sup> (Ref. [2, 43]). *T<sup>c</sup>* , superconducting transition temperature; γ , Sommerfeld constant; (0) Δ*<sup>S</sup>* , smaller gap at *T* → 0 ; (0) Δ*<sup>L</sup>* , larger gap at *T* → 0 ; *x*, fraction of the renormalized DOS of the band in which the smaller gap opens.

|                             | Nb3Sn     | MgB2 |
|-----------------------------|-----------|------|
| Tc<br>(K)                   | 17.8      | 38   |
| γ (mJ K-2<br>gat-1<br>)     | 13.7      | 0.9  |
| 2Δ<br>(0)/<br>k<br>BTc<br>S | 0.8±0.05  | 1.3  |
| 2Δ<br>(0)/<br>k<br>BTc<br>L | 4.9±0.05  | 3.9  |
| x                           | 7.5%      | 50%  |
| ΔS<br>(0)<br>(meV)          | 0.61±0.05 | 2.1  |
| ΔL<br>(0)<br>(meV)          | 3.68±0.05 | 6.2  |

#### **References**

- A. Y. Liu, I. I. Mazin, and J. Kortus, Phys. Rev. Lett. **87**, 087005 (2001).
- F. Bouquet, Y. Wang, I. Sheikin, P. Toulemonde, M. Eisterer, H. W. Weber, S. Lee, S. Tajima, and A. Junod, Physica C **385**, 192 (2003).
- G. Binnig, A. Baratoff, H. E. Hoenig, and J. G. Bednorz, Phys. Rev. Lett. **45**, 1352 (1980).
- L. Y. L. Shen, N. M. Senozan, and N. E. Phillips, Phys. Rev. Lett. **14**, 1025 (1965).
- J. W. Hafstrom and M. L. A. MacVicar, Phys. Rev. B **2**, 4511 (1970).
- H. Suhl, B. T. Matthias, and L. R. Walker, Phys. Rev. Lett. **3**, 552 (1959).
- I. I. Mazin, O. K. Anderson, O. Jepsen, O. V. Dolgov, J. Kortus, A. A. Golubov, A. B. Kuz'menko, and D. van der Marel, Phys. Rev. Lett. **89**, 107002 (2002).
- L. R. Testardi, Rev. Mod. Phys. **47**, 637 (1975).
- M. Weger and I. B. Goldberg, in *Solid State Physics: Advances in Research and Applications*, edited by H. Ehrenreich, R. Seitz and D. Turnbull (Academic, New York, 1973), Vol. 28.
- L. Y. L. Shen, Phys. Rev. Lett. **29**, 1082 (1972).
- J. Kwo and T. H. Geballe, Physica **B109&110**, 1665 (1982).
- F. Bouquet, Y. Wang, R. A. Fisher, D. G. Hinks, J. D. Jorgensen, A. Junod, and N. E. Phillips, Europhys. Lett. **56**, 856 (2001).
- G. Goll, private communication (2004).
- L. J. Vieland and A. W. Wicklund, Phys. Lett. **23**, 223 (1966).
- A. Junod, J. Muller, H. Rietschel, and E. Schneider, J. Phys. Chem. Solids **39**, 317 (1978).
- J. D. Axe and A. Shirane, Phys. Rev. B **8**, 1965 (1973).
- G. R. Stewart, B. Cort, and G. W. Webb, Phys. Rev. B **24**, 3841 (1981).
